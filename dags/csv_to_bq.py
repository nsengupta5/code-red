...
with DAG(
    ...
    run_dataflow = BashOperator(
        ...
        bash_command="""
        gcloud dataflow flex-template run csv-to-bq-$(date +%Y%m%d) \
          ...
          --parameters input=gs://dummy-data-258083003066/input/sheep_colour_preferences.csv,\
output_table=project-990b8649-da36-4d4c-9d9:animal_facts.sheep_colour_preferences,\
error_table=project-990b8649-da36-4d4c-9d9:animal_facts.sheep_colour_bad_rows
        """
    )
