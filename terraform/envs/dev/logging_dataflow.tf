...
AND severity>=ERROR
AND (
  textPayload:"OutOfMemoryError" OR jsonPayload:"OutOfMemoryError" OR jsonPayload.message:"OutOfMemoryError"
  OR textPayload:"OOMKilled" OR jsonPayload:"OOMKilled" OR jsonPayload.message:"OOMKilled"
  OR textPayload:"MemoryError" OR jsonPayload:"MemoryError" OR jsonPayload.message:"MemoryError"
